...
public final class Client {
    ...
    fileprivate struct Constants {
        static var location: String = "https://gitlab.com/api/v3/"
    }
    ...
    public init(location: URL = URL(string: Client.Constants.location)!,
    ...
    public func execute<A>(resource: Resource<A>,
                        completion: @escaping (Result<Response<A>, ClientError>) -> ()) {
...
public extension Client {
    ...
    convenience public init(location: URL = URL(string: Client.Constants.location)!,
                            session: URLSession = URLSession.shared,
